...
define(['jquery', 'loader','numeral', 'history', 'datatables.net', 'datatables.net-bs', 'resize-element', 'datatables.net-buttons', 'datatables.net-buttonsColVis'], function($) {
	return {
		/**
		...
		createTable: function(opts, $container) {
			...
			if (opts.advancedHeader) {
				...
				new $.fn.dataTable.Buttons(dataTableRef, {buttons: [{
						extend: 'colvis',
				...
				$(dataTableRef.buttons().container()[dataTableRef.buttons().container().length - 1])
