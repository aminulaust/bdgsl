...
<html lang="en">
<head>
    <title>Code coverage report for arrow-docgen/lib/blocks.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">all files</a> / <a href="index.html">arrow-docgen/lib/</a> blocks.js
    </h1>
    <div class='clearfix'>
...
&nbsp;
		...
		<span class="missing-if-branch" title="else path not taken" >E</span>if (apis) {
			markdown.push('### APIs using ' + name + ' block');
			markdown.push('');
			apis.forEach(function (apiobj) {
				var api = apiobj.api,
					group = apiobj.name;
				<span class="missing-if-branch" title="if path not taken" >I</span>if (apiobj.documented !== undefined &amp;&amp; <span class="branch-1 cbranch-no" title="branch not covered" >!apiobj.documented)</span> {
