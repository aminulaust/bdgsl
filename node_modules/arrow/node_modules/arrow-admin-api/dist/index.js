...
function configure(app, prefix, arrow, devmode, swagger) {
	...
	swagger.info('API Builder Console API', '1.0', fs.readFileSync(path.join(__dirname, '../swaggerdoc.md'), 'utf8')).securityDefinition('basicAuth', {
		type: 'basic',
	...
	EndpointsAPI.bind(new EndpointsController(ctx), ctx);
	FlowsAPI.bind(new FlowsController(ctx), ctx);
