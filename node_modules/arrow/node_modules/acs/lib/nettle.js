...
program.command('new <name>')
    ...
    .option('--type <type>', 'create new app of specified type, available option is \'free\' and \'image\'.')
...
program.command('publish [npm_username] [npm_password] [appname]')
    ...
    .option('--image <name[:tag]>', 'the name of the docker image, will use tag \'latest\' if tag is not specified. Only \'image\' type needs to specify this option')
    .option('--app_version <version>', 'the version of the app to be published, only \'image\' type needs to specify this option')
    ...
    .action(function() {
        ...
        this.app_version = cmd.app_version;
    });
...
function main(args) {
    ...
    switch (cmd) {
        ...
        case 'transfer-domain':
            ...
            var noLoginCommand = _.contains(['logout', 'login'], cmd);
