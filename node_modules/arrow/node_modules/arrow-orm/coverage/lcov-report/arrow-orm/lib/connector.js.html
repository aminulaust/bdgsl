...
<html lang="en">
<head>
    <title>Code coverage report for arrow-orm/lib/connector.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">all files</a> / <a href="index.html">arrow-orm/lib/</a> connector.js
    </h1>
    <div class='clearfix'>
      <div class='fl pad1y space-right2'>
        <span class="strong">82.33% </span>
        <span class="quiet">Statements</span>
        <span class='fraction'>261/317</span>
      </div>
      <div class='fl pad1y space-right2'>
        <span class="strong">75.21% </span>
        <span class="quiet">Branches</span>
        <span class='fraction'>176/234</span>
      </div>
      <div class='fl pad1y space-right2'>
      ...
      <div class='fl pad1y space-right2'>
        <span class="strong">84.14% </span>
        <span class="quiet">Lines</span>
        <span class='fraction'>260/309</span>
      </div>
    </div>
  </div>
...
749
750
751</td><td class="line-coverage quiet"><span class="cline-any cline-neutral">&nbsp;</span>
...
&nbsp;
	...
	<span class="missing-if-branch" title="if path not taken" >I</span>if (!this.pkginfo &amp;&amp; this.config &amp;&amp; this.config.pkginfo) {
<span class="cstat-no" title="statement not covered" >		this.pkginfo = this.config.pkginfo;</span>
	}
&nbsp;
...
function wrapDelegate(connector, method, delegate_) {
	...
	connector[method] = function methodWrapper() {
		...
		<span class="missing-if-branch" title="if path not taken" >I</span>if (this.connected &amp;&amp; !this.loginRequired) {
<span class="cstat-no" title="statement not covered" >			return delegate.apply(this, arguments);</span>
		}
		// we're not connected, call through to connect before continuing
			...
			var callback = arguments[arguments.length - 1],
				...
				self = this,
				connect = function () {
					<span class="missing-if-branch" title="else path not taken" >E</span>if (connector.connect) {
...
<span class="cstat-no" title="statement not covered" >						delegate.apply(self, args);</span>
					}
				};
			<span class="missing-if-branch" title="else path not taken" >E</span>if (self.loginRequired) {
...
&nbsp;
	...
	if (impl.filename) {
		<span class="missing-if-branch" title="else path not taken" >E</span>if (!impl.pkginfo) {
			impl.pkginfo = _.pick(
...
&nbsp;
		...
		<span class="missing-if-branch" title="if path not taken" >I</span>if (!impl.models &amp;&amp; fs.existsSync(modelsDir) &amp;&amp; <span class="branch-2 cbranch-no" title="branch not covered" >Connector.Arrow)</span> {
<span class="cstat-no" title="statement not covered" >			impl.modelsDir = modelsDir;</span>
...
<span class="cstat-no" title="statement not covered" >			impl.models = Connector.Arrow.loadModelsForConnector(impl.name || impl.pkginfo.name, impl);</span>
		}
&nbsp;
		// Look for an example config file.
		var exampleConfig = path.resolve(path.join(impl.filename, '..', '..', 'conf', 'example.config.js'));
		<span class="missing-if-branch" title="else path not taken" >E</span>if (!impl.defaultConfig &amp;&amp; fs.existsSync(exampleConfig)) {
				...
				.forEach(function (f) {
					try {
						...
						for (var key in module) {
							<span class="missing-if-branch" title="else path not taken" >E</span>if (module.hasOwnProperty(key) &amp;&amp; _.isFunction(module[key]) &amp;&amp; !impl[key]) {
								impl[key] = module[key];
							}
						}
					}
...
&nbsp;
	ConnectorConstructor.extend = <span class="fstat-no" title="function not covered" >function (extendingImpl) {</span>
<span class="cstat-no" title="statement not covered" >		return classExtend(_.merge(impl, extendingImpl));</span>
	};
&nbsp;
 ...
 * @returns {Boolean}
 */
Connector.prototype.isConnected = <span class="fstat-no" title="function not covered" >function isConnected() {</span>
<span class="cstat-no" title="statement not covered" >	return this.connected;</span>
};
&nbsp;
/**
...
Connector.prototype.connect = function (callback) {
	...
	if (this.fetchMetadata) {
		...
		tasks.push(function metadataTask(next) {
			<span class="missing-if-branch" title="else path not taken" >E</span>if (!this.metadata) {
	...
	if (this.fetchConfig) {
		tasks.push(function fetchConfigTask(next) {
			this.fetchConfig(function fetchConfigTaskCallback(err, config) {
				...
				<span class="missing-if-branch" title="if path not taken" >I</span>if (possibleErr !== true) {
<span class="cstat-no" title="statement not covered" >					next(possibleErr);</span>
				}
				else {
					next();
				}
		...
		tasks.push(function fetchSchemaTask(next) {
			this.fetchSchema(function fetchSchemaTaskCallback(err, schema) {
				...
				<span class="missing-if-branch" title="else path not taken" >E</span>if (schema) {
					this.metadata = _.merge(this.metadata || <span class="branch-1 cbranch-no" title="branch not covered" >{},</span> {schema: schema});
					this.schema = schema;
				}
				if (!this._createdModelsFromSchema &amp;&amp; this.createModelsFromSchema &amp;&amp; (this.config.generateModelsFromSchema === undefined || <span class="branch-3 cbranch-no" title="branch not covered" >this.config.generateModelsFromSchema)</span>) {
 ...
 */
Connector.prototype.disconnect = <span class="fstat-no" title="function not covered" >function disconnect(callback) {</span>
<span class="cstat-no" title="statement not covered" >	if (!this.connected || this.config.enabled === false) {</span>
...
<span class="cstat-no" title="statement not covered" >	if (this._disconnect) {</span>
<span class="cstat-no" title="statement not covered" >		tasks.push(<span class="fstat-no" title="function not covered" >function disconnectTask(next) {</span></span>
<span class="cstat-no" title="statement not covered" >			this._disconnect(next);</span>
		}.bind(this));
	}
<span class="cstat-no" title="statement not covered" >	async.series(tasks, <span class="fstat-no" title="function not covered" >function disconnectCallback(err) {</span></span>
...
Connector.prototype.validateConfig = function validateConfig() {
	var metadata = this.metadata,
		config = this.config || <span class="branch-1 cbranch-no" title="branch not covered" >{};</span>
&nbsp;
...
&nbsp;
	for (var i = 0; i &lt; metadata.fields.length; i++) {
		...
		if (!config[field.name]) {
			<span class="missing-if-branch" title="else path not taken" >E</span>if (field.required) {
				this.logDefaultConfig();
				return new Error(field.name + ' is a required config property for the ' + this.name + ' connector!');
			}
<span class="cstat-no" title="statement not covered" >			if (field.default !== undefined) {</span>
<span class="cstat-no" title="statement not covered" >				config[field.name] = field.default;</span>
			}
		}
		else <span class="missing-if-branch" title="else path not taken" >E</span>if (field.validator) {
			var validator;
			<span class="missing-if-branch" title="else path not taken" >E</span>if (_.isRegExp(field.validator)) {
				validator = field.validator;
			}
			else <span class="cstat-no" title="statement not covered" >if (field.validator.type === 'regexp') {</span>
<span class="cstat-no" title="statement not covered" >				validator = new RegExp(field.validator.value, field.validator.flags);</span>
			}
			else {
<span class="cstat-no" title="statement not covered" >				return new Error('The connector ' + this.name + ' has an invalid validator for ' + field.name + '!');</span>
			}
...
&nbsp;
		var hasAResult = result &amp;&amp; result.length,
			...
			allowUpdating = args.update === undefined || <span class="branch-1 cbranch-no" title="branch not covered" >args.update === true;</span>
&nbsp;
		if (!hasAResult &amp;&amp; allowInserting) {
			return this.create(Model, doc, function (err, record) {
				callback(err, args.new ? <span class="branch-0 cbranch-no" title="branch not covered" >record </span>: {});
			});
		}
&nbsp;
...
Connector.prototype.distinct = function distinct(Model, field, options, callback) {
	<span class="missing-if-branch" title="if path not taken" >I</span>if (_.isFunction(options)) {
...
<span class="cstat-no" title="statement not covered" >			return callback(err);</span>
		...
		else <span class="missing-if-branch" title="if path not taken" >I</span>if (!results) {
<span class="cstat-no" title="statement not covered" >			return callback();</span>
		}
		var found = {},
			array = [],
...
&nbsp;
		results = array;
		callback(null, Array.isArray(results) ? results : <span class="branch-1 cbranch-no" title="branch not covered" >new Collection(model, results))</span>;
	});
};
&nbsp;
/**
 ...
 */
Connector.prototype.count = <span class="fstat-no" title="function not covered" >function count(Model, options, callback) {</span>
<span class="cstat-no" title="statement not covered" >	if (_.isFunction(options)) {</span>
<span class="cstat-no" title="statement not covered" >		callback = options;</span>
<span class="cstat-no" title="statement not covered" >		options = {};</span>
	}
<span class="cstat-no" title="statement not covered" >	this.query(Model, options, <span class="fstat-no" title="function not covered" >function (err, results) {</span></span>
<span class="cstat-no" title="statement not covered" >		if (err) {</span>
<span class="cstat-no" title="statement not covered" >			return callback(err);</span>
		}
		else {
<span class="cstat-no" title="statement not covered" >			var count = results.length;</span>
<span class="cstat-no" title="statement not covered" >			if (options.distinct) {</span>
...
<span class="cstat-no" title="statement not covered" >				for (var c = 0; c &lt; results.length; c++) {</span>
<span class="cstat-no" title="statement not covered" >					var row = results[c],</span>
						value = row.get(options.distinct);
<span class="cstat-no" title="statement not covered" >					if (value in found) {</span>
<span class="cstat-no" title="statement not covered" >						continue;</span>
					}
<span class="cstat-no" title="statement not covered" >					found[value] = 1;</span>
