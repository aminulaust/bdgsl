...
<html lang="en">
<head>
    <title>Code coverage report for arrow-orm/lib/instance.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">all files</a> / <a href="index.html">arrow-orm/lib/</a> instance.js
    </h1>
    <div class='clearfix'>
      <div class='fl pad1y space-right2'>
        <span class="strong">88.28% </span>
        <span class="quiet">Statements</span>
        <span class='fraction'>256/290</span>
      </div>
      <div class='fl pad1y space-right2'>
        <span class="strong">85.21% </span>
        <span class="quiet">Branches</span>
        <span class='fraction'>219/257</span>
      </div>
      <div class='fl pad1y space-right2'>
...
700
701
702</td><td class="line-coverage quiet"><span class="cline-any cline-neutral">&nbsp;</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">1×</span>
<span class="cline-any cline-yes">1148×</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">1148×</span>
...
function Instance(model, values, skipNotFound) {
	<span class="missing-if-branch" title="if path not taken" >I</span>if (!model.fields) {
<span class="cstat-no" title="statement not covered" >		throw new ORMError('missing model "fields" property');</span>
	}
	this._values = {};
	this._model = model;
	this._dirty = false;
...
&nbsp;
	...
	Object.keys(model.fields).forEach(function instanceIterator(property) {
		...
		<span class="missing-if-branch" title="if path not taken" >I</span>if (!field.type) {
<span class="cstat-no" title="statement not covered" >			throw new ValidationError(property, "required type property missing for field");</span>
		}
		<span class="missing-if-branch" title="else path not taken" >E</span>if (!field.type.name) {
			field.type = String(field.type);
		}
		else {
<span class="cstat-no" title="statement not covered" >			field.type = field.type.name.toLowerCase();</span>
		}
		if (_.isString(field.model)) {
			<span class="missing-if-branch" title="if path not taken" >I</span>if (Instance.Arrow &amp;&amp; <span class="branch-1 cbranch-no" title="branch not covered" >Instance.Arrow.getModel(field.model))</span> {
<span class="cstat-no" title="statement not covered" >				field.Model = Instance.Arrow.getModel(field.model);</span>
			}
			else <span class="missing-if-branch" title="else path not taken" >E</span>if (model.connector &amp;&amp; model.connector.models &amp;&amp; model.connector.models[field.model]) {
				field.Model = model.connector.models[field.model];
			}
		}
		else <span class="missing-if-branch" title="if path not taken" >I</span>if (_.isObject(field.model)) {
<span class="cstat-no" title="statement not covered" >			field.Model = field.model;</span>
<span class="cstat-no" title="statement not covered" >			field.model = field.Model.name;</span>
		}
...
&nbsp;
	...
	model.methods &amp;&amp; Object.keys(model.methods).forEach(function modelMethodIterator(name) {
		...
		<span class="missing-if-branch" title="else path not taken" >E</span>if (_.isFunction(o)) {
			this[name] = o.bind(this);
		}
		else {
<span class="cstat-no" title="statement not covered" >			this[name] = o;</span>
		}
	}.bind(this));
&nbsp;
	// set the values
...
<span class="cstat-no" title="statement not covered" >			break;</span>
		...
		case 'number':
		{
			<span class="missing-if-branch" title="else path not taken" >E</span>if (type === 'string') {
				...
				<span class="missing-if-branch" title="else path not taken" >E</span>if (value == parsedInt) { // jshint ignore:line
					this.set(name, parsedInt);
					return true;
				}
<span class="cstat-no" title="statement not covered" >				var parsedFloat = parseFloat(value);</span>
<span class="cstat-no" title="statement not covered" >				if (value == parsedFloat) { // jshint ignore:line</span>
<span class="cstat-no" title="statement not covered" >					this.set(name, parsedFloat);</span>
...
<span class="cstat-no" title="statement not covered" >				this.set(name, new Date(value));</span>
<span class="cstat-no" title="statement not covered" >				return true;</span>
			}
			else <span class="missing-if-branch" title="else path not taken" >E</span>if (value instanceof Date) {
				return true;
			}
<span class="cstat-no" title="statement not covered" >			break;</span>
		}
		case 'object':
		{
			<span class="missing-if-branch" title="if path not taken" >I</span>if (value instanceof Date) {
<span class="cstat-no" title="statement not covered" >				return true;</span>
			}
			<span class="missing-if-branch" title="else path not taken" >E</span>if (typeof(value) === 'string' &amp;&amp; value === '') {
				this.set(name, {});
				return true;
			}
<span class="cstat-no" title="statement not covered" >			break;</span>
...
Instance.prototype.validateField = function validateField(name, v) {
	...
	if (hasValue &amp;&amp; field.type.toLowerCase() !== (typeof value).toLowerCase()) {
		...
		<span class="missing-if-branch" title="if path not taken" >I</span>if (!builtInCoerce &amp;&amp; !externalCoerce) {
<span class="cstat-no" title="statement not covered" >			throw new ValidationError(name, "invalid type (" + (typeof value) + ") for field: " + name + ". Should be " + field.type + ". Value was: " + util.inspect(value));</span>
		}
	}
	...
	if (field.validator) {
		...
		if (field.required || hasValue) {
			...
			} else <span class="missing-if-branch" title="else path not taken" >E</span>if (typeof field.validator === 'function') {
				var msg;
				try {
					msg = field.validator(value);
				}
				catch (E) {
<span class="cstat-no" title="statement not covered" >					if (E instanceof ValidationError) {</span>
<span class="cstat-no" title="statement not covered" >						throw E;</span>
					}
					else {
<span class="cstat-no" title="statement not covered" >						throw new ValidationError(name, E.message);</span>
					}
				}
				if (msg) {
...
Instance.prototype.validateFields = function validateFields() {
	...
	if (errors.length &gt; 0) {
		<span class="missing-if-branch" title="else path not taken" >E</span>if (errors.length === 1) {
			throw errors[0];
		}
		else {
<span class="cstat-no" title="statement not covered" >			throw new ValidationError(_.pluck(errors, 'field').join(', '), _.pluck(errors, 'message').join('\n'));</span>
		}
	}
};
&nbsp;
...
Instance.prototype.toJSON = function toJSON() {
	...
	for (var key in this._model.fields) {
		<span class="missing-if-branch" title="else path not taken" >E</span>if (this._model.fields.hasOwnProperty(key)) {
&nbsp;
			...
			<span class="missing-if-branch" title="if path not taken" >I</span>if (this._skipNotFoundFields &amp;&amp;
...
<span class="cstat-no" title="statement not covered" >				continue;</span>
			...
			<span class="missing-if-branch" title="else path not taken" >E</span>if (!_.isFunction(v)) {
				if (v !== undefined) {
...
Instance.prototype.change = function (name, value) {
	<span class="missing-if-branch" title="else path not taken" >E</span>if (name in this._values) {
		this._values[name] = value;
		this._dirty = true;
		this._dirtyfields[name] = value;
	}
	else {
<span class="cstat-no" title="statement not covered" >		throw new ORMError('field not found: ' + name);</span>
	}
};
&nbsp;
/**
		...
		if (skipNotFound) {
			...
			if (removeKeys.length) {
				removeKeys.forEach(function (k) {
					<span class="missing-if-branch" title="if path not taken" >I</span>if (!(k in this._fieldmap_by_name)) {
						// only undefine if not in the field mapping
<span class="cstat-no" title="statement not covered" >						this._values[k] = undefined;</span>
					}
				}.bind(this));
			}
		}
		if (this._model.validator) {
			// only run validators if required or if we have a value
			<span class="missing-if-branch" title="else path not taken" >E</span>if (typeof this._model.validator === 'function') {
				var msg;
				try {
...
<span class="cstat-no" title="statement not covered" >						throw new ValidationError(this._model.name, E.message);</span>
					}
				}
				if (msg) {
...
&nbsp;
		...
		<span class="missing-if-branch" title="if path not taken" >I</span>if (name.charAt(0) === '_') {
<span class="cstat-no" title="statement not covered" >			if (internal.indexOf(name) !== -1) {</span>
...
&nbsp;
		<span class="missing-if-branch" title="if path not taken" >I</span>if (!definition &amp;&amp; !skipNotFound) {
<span class="cstat-no" title="statement not covered" >			throw new ValidationError(name, "invalid field: " + name);</span>
		}
...
&nbsp;
		if (/date/i.test(definition.type) &amp;&amp; typeof value === 'string') {
			...
			value = isNaN(dt) ? <span class="branch-0 cbranch-no" title="branch not covered" >null </span>: dt;
		}
&nbsp;
		// validate this field
