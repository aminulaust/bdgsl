...
<html lang="en">
<head>
    <title>Code coverage report for arrow-orm/lib/model.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">all files</a> / <a href="index.html">arrow-orm/lib/</a> model.js
    </h1>
    <div class='clearfix'>
      <div class='fl pad1y space-right2'>
        <span class="strong">80.84% </span>
        <span class="quiet">Statements</span>
        <span class='fraction'>519/642</span>
      </div>
      <div class='fl pad1y space-right2'>
        <span class="strong">79.14% </span>
        <span class="quiet">Branches</span>
        <span class='fraction'>406/513</span>
      </div>
      <div class='fl pad1y space-right2'>
      ...
      <div class='fl pad1y space-right2'>
        ...
        <span class='fraction'>519/635</span>
      </div>
    </div>
  </div>
...
1836
1837
1838</td><td class="line-coverage quiet"><span class="cline-any cline-neutral">&nbsp;</span>
	...
	if (this._promise) {
		...
		for (var name in this) {
			...
			if (typeof fn === 'function') {
				<span class="missing-if-branch" title="else path not taken" >E</span>if (this.connector) {
					var mapFn = dispatchers[name];
					if (mapFn) {
						var cnFn = this[mapFn];
						// we don't have a connector fn, skip it
						<span class="missing-if-branch" title="if path not taken" >I</span>if (typeof cnFn !== 'function') {
...
&nbsp;
	...
	this.methods &amp;&amp; Object.keys(this.methods).forEach(function (name) {
		...
		this[name] = fn;
		// bind the delegate
		<span class="missing-if-branch" title="if path not taken" >I</span>if (this._promise &amp;&amp; <span class="branch-1 cbranch-no" title="branch not covered" >typeof fn === 'function')</span> {
<span class="cstat-no" title="statement not covered" >			utillib.createTransactionLoggedDelegate(this, 'model', this, name);</span>
		}
	}.bind(this));
&nbsp;
};
 ...
 */
Model.removeListener = <span class="fstat-no" title="function not covered" >function removeListener() {</span>
<span class="cstat-no" title="statement not covered" >	ModelClass.removeListener.apply(ModelClass, arguments);</span>
};
&nbsp;
/**
...
function extendOrReduce(instance, name, definition, extend) {
	...
	<span class="missing-if-branch" title="else path not taken" >E</span>if (model.fields) {
		var fields = instance.fields;
		if (extend) {
			for (var key in model.fields) {
				<span class="missing-if-branch" title="else path not taken" >E</span>if (model.fields.hasOwnProperty(key)) {
			...
			Object.keys(model.fields).forEach(function (name) {
				<span class="missing-if-branch" title="if path not taken" >I</span>if (name in fields) {
<span class="cstat-no" title="statement not covered" >					model.fields[name] = _.merge(_.cloneDeep(fields[name]), model.fields[name]);</span>
				} else { 
...
<span class="cstat-no" title="statement not covered" >		model.fields = _.cloneDeep(instance.fields);</span>
	}
	...
	model.actions = (definition &amp;&amp; definition.actions) ? <span class="branch-0 cbranch-no" title="branch not covered" >definition.actions </span>: instance.actions;
	model.disabledActions = (definition &amp;&amp; definition.disabledActions) ? <span class="branch-0 cbranch-no" title="branch not covered" >definition.disabledActions </span>: instance.disabledActions;
...
Model.prototype.createAPI = function createAPI() {
	...
	return {
		...
		action: <span class="fstat-no" title="function not covered" >function createAction(req, resp, next) {</span>
<span class="cstat-no" title="statement not covered" >			try {</span>
<span class="cstat-no" title="statement not covered" >				req.model.create(req.params, next);</span>
			}
			catch (E) {
	...
	try {
		...
		if (cache) {
			next = function (err, result) {
				<span class="missing-if-branch" title="else path not taken" >E</span>if (result &amp;&amp; result.getPrimaryKey) {
					cache.del('count');
					cache.del('findAll');
		...
		<span class="missing-if-branch" title="else path not taken" >E</span>if (E instanceof ORMError) {
...
Model.prototype.updateAPI = function updateAPI() {
	...
	return {
		...
		action: <span class="fstat-no" title="function not covered" >function updateAction(req, resp, next) {</span>
<span class="cstat-no" title="statement not covered" >			req.model.fetch(req.params.id, resp.createCallback(null, <span class="fstat-no" title="function not covered" >function putSuccessCallback(model, cb) {</span></span>
<span class="cstat-no" title="statement not covered" >				try {</span>
<span class="cstat-no" title="statement not covered" >					model.set(req.params);</span>
<span class="cstat-no" title="statement not covered" >					model.save(cb);</span>
				}
				catch (E) {
<span class="cstat-no" title="statement not covered" >					return next(E);</span>
				}
	...
	Model.prototype.save = function save(instance, callback) {
		...
		if (!(instance instanceof Instance) || instance.isUnsaved()) {
			if (!(instance instanceof Instance)) {
				...
				<span class="missing-if-branch" title="else path not taken" >E</span>if (instance.id) {
					return this.findByID(instance.id, function findByIDCallback(err, _instance) {
						...
						<span class="missing-if-branch" title="if path not taken" >I</span>if (!_instance) { <span class="cstat-no" title="statement not covered" >return callback("trying to update, couldn't find record with primary key: " + instance.id + " for " + this.name); </span>}
						_instance.set(instance);
						this.update(_instance, callback);
					}.bind(this));
				}
				// otherwise, we can try instantiating the instance directly right here.
<span class="cstat-no" title="statement not covered" >				this.instance(instance, false);</span>
			}
			var cache = this.cache;
			this.getConnector().save(this, instance, function saveCallback(err, result) {
				<span class="missing-if-branch" title="if path not taken" >I</span>if (err) { <span class="cstat-no" title="statement not covered" >return callback &amp;&amp; callback(err); </span>}
...
<span class="cstat-no" title="statement not covered" >						cache.del('findAll');</span>
<span class="cstat-no" title="statement not covered" >						cache.set(result.getPrimaryKey(), result);</span>
					}
				}
				else <span class="cstat-no" title="statement not covered" >if (cache) {</span>
<span class="cstat-no" title="statement not covered" >					cache.reset();</span>
				}
&nbsp;
...
Model.prototype.deleteAPI = function deleteAPI() {
	return {
		...
		action: <span class="fstat-no" title="function not covered" >function deleteAction(req, resp, next) {</span>
<span class="cstat-no" title="statement not covered" >			try {</span>
<span class="cstat-no" title="statement not covered" >				req.model.remove(req.params.id, next);</span>
			}
			catch (E) {
<span class="cstat-no" title="statement not covered" >				return next(E);</span>
			}
...
Model.prototype.delete =
	Model.prototype.remove = function remove(instance, callback) {
		<span class="missing-if-branch" title="if path not taken" >I</span>if (typeof instance === 'object' &amp;&amp; instance._deleted) {
<span class="cstat-no" title="statement not covered" >			return callback &amp;&amp; callback(new ORMError('instance has already been deleted'));</span>
		}
		// quick validation
		<span class="missing-if-branch" title="if path not taken" >I</span>if (_.isFunction(instance)) {
<span class="cstat-no" title="statement not covered" >			callback = instance;</span>
<span class="cstat-no" title="statement not covered" >			instance = undefined;</span>
		...
		if (typeof instance !== 'object') {
			return this.findByID(instance, function findByIDCallback(err, _instance) {
				<span class="missing-if-branch" title="if path not taken" >I</span>if (err) { <span class="cstat-no" title="statement not covered" >return callback(err); </span>}
				<span class="missing-if-branch" title="if path not taken" >I</span>if (!_instance) { <span class="cstat-no" title="statement not covered" >return callback("trying to remove, couldn't find record with primary key: " + instance + " for " + this.name); </span>}
		...
		this.getConnector().delete(this, instance, function deleteCallback(err, result) {
			...
			if (result) {
				...
				result.emit('delete');
				<span class="missing-if-branch" title="if path not taken" >I</span>if (cache) {
<span class="cstat-no" title="statement not covered" >					cache.del('count');</span>
<span class="cstat-no" title="statement not covered" >					cache.del('findAll');</span>
<span class="cstat-no" title="statement not covered" >					cache.set(result.getPrimaryKey(), result);</span>
				}
			}
			else <span class="missing-if-branch" title="if path not taken" >I</span>if (cache) {
<span class="cstat-no" title="statement not covered" >				cache.reset();</span>
			}
			callback &amp;&amp; callback(null, result);
		});
...
Model.prototype.deleteAllAPI = function deleteAllAPI() {
	return {
		...
		action: <span class="fstat-no" title="function not covered" >function deleteAction(req, resp, next) {</span>
<span class="cstat-no" title="statement not covered" >			req.model.deleteAll(resp.createCallback(null, <span class="fstat-no" title="function not covered" >function delAllSuccessCallback(count, cb) {</span></span>
<span class="cstat-no" title="statement not covered" >				if (count !== undefined) {</span>
<span class="cstat-no" title="statement not covered" >					resp.noContent(cb);</span>
				}
				else {
<span class="cstat-no" title="statement not covered" >					resp.notFound(cb);</span>
				}
			}, next));
		}
	};
...
Model.prototype.deleteAll =
	Model.prototype.removeAll = function removeAll(callback) {
		...
		if (cache) {
			next = function () {
				cache.reset();
				return callback &amp;&amp; <span class="branch-1 cbranch-no" title="branch not covered" >callback.apply(this, arguments);</span>
			};
		}
...
Model.prototype.distinctAPI = function distinctAPI() {
	...
	result.action = <span class="fstat-no" title="function not covered" >function distinctAction(req, resp, next) {</span>
<span class="cstat-no" title="statement not covered" >		var field = req.params.field;</span>
<span class="cstat-no" title="statement not covered" >		delete req.params.field;</span>
<span class="cstat-no" title="statement not covered" >		resp.stream(req.model.distinct, field, req.params, next);</span>
	};
	return result;
};
&nbsp;
...
Model.prototype.findByIDAPI = function findByIDAPI() {
	return {
		...
		action: <span class="fstat-no" title="function not covered" >function findByIDAction(req, resp, next) {</span>
<span class="cstat-no" title="statement not covered" >			try {</span>
<span class="cstat-no" title="statement not covered" >				resp.stream(req.model.findByID, req.params.id, next);</span>
			}
			catch (E) {
<span class="cstat-no" title="statement not covered" >				return next(E);</span>
			}
 ...
 */
Model.prototype.findOne = <span class="fstat-no" title="function not covered" >function () {</span>
...
<span class="cstat-no" title="statement not covered" >	var log = connector.logger ? connector.logger.warn.bind(connector.logger) : console.warn.bind(console);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >	log('The findOne method of a model is deprecated and will be removed in an upcoming major release. Please use findById instead.');</span>
&nbsp;
	// Fallback to findByID
<span class="cstat-no" title="statement not covered" >	return this.findByID.apply(this, arguments);</span>
};
&nbsp;
/**
 * Finds a model instance using the primary key.
...
Model.prototype.findByID = Model.prototype.findById = function findByID(id, callback) {
	try {
		...
		<span class="missing-if-branch" title="else path not taken" >E</span>if (connector.findByID) {
			connector[_.isArray(id) ? 'findManyByID' : 'findByID'](this, id, next);
		} else <span class="cstat-no" title="statement not covered" >if (connector.findById) {</span>
<span class="cstat-no" title="statement not covered" >			connector[_.isArray(id) ? 'findManyById' : 'findById'](this, id, next);</span>
		} else {
<span class="cstat-no" title="statement not covered" >			connector[_.isArray(id) ? 'findOneMany' : 'findOne'](this, id, next);</span>
		}
	} catch (E) {
<span class="cstat-no" title="statement not covered" >		return callback(E);</span>
	}
...
Model.prototype.findAndModifyAPI = function findAndModifyAPI() {
	...
	return {
		...
		action: <span class="fstat-no" title="function not covered" >function queryAction(req, resp, next) {</span>
<span class="cstat-no" title="statement not covered" >			try {</span>
<span class="cstat-no" title="statement not covered" >				resp.stream(req.model.findAndModify, req.query, req.body, next);</span>
			}
			catch (E) {
<span class="cstat-no" title="statement not covered" >				return next(E);</span>
			}
...
<span class="cstat-no" title="statement not covered" >				cache.reset();</span>
<span class="cstat-no" title="statement not covered" >				return callback &amp;&amp; callback.apply(this, arguments);</span>
			};
		}
...
Model.prototype.findAllAPI = function findAllAPI() {
	return {
		...
		action: <span class="fstat-no" title="function not covered" >function findAllAction(req, resp, next) {</span>
<span class="cstat-no" title="statement not covered" >			try {</span>
<span class="cstat-no" title="statement not covered" >				resp.stream(req.model.findAll, next);</span>
			}
			catch (E) {
<span class="cstat-no" title="statement not covered" >				return next(E);</span>
			}
		...
		if (cache) {
			...
			next = function (err, results) {
				<span class="missing-if-branch" title="else path not taken" >E</span>if (results) {
					...
					<span class="missing-if-branch" title="else path not taken" >E</span>if (_.isArray(results)) {
						for (var i = 0; i &lt; results.length; i++) {
							var result = results[i];
							<span class="missing-if-branch" title="else path not taken" >E</span>if (result.getPrimaryKey()) {
								cache.set(result.getPrimaryKey(), result);
							}
						}
					}
...
&nbsp;
		<span class="missing-if-branch" title="else path not taken" >E</span>if (this.getConnector().findAll) {
			return this.getConnector().findAll(this, next);
		}
		else {
<span class="cstat-no" title="statement not covered" >			return this.query({limit: 1000}, next);</span>
		}
	}
	catch (E) {
<span class="cstat-no" title="statement not covered" >		callback(E);</span>
...
Model.prototype.countAPI = function countAPI() {
	...
	result.action = <span class="fstat-no" title="function not covered" >function countAction(req, resp, next) {</span>
<span class="cstat-no" title="statement not covered" >		resp.stream(req.model.count, req.params, <span class="fstat-no" title="function not covered" >function (err, results) {</span></span>
...
<span class="cstat-no" title="statement not covered" >				count = results.length;</span>
			...
			else <span class="cstat-no" title="statement not covered" >if (typeof(results) === 'number') {</span>
<span class="cstat-no" title="statement not covered" >				count = results;</span>
			}
<span class="cstat-no" title="statement not covered" >			return next(null, count);</span>
		});
	};
	return result;
};
...
Model.prototype.count = function count(options, callback) {
	try {
		<span class="missing-if-branch" title="if path not taken" >I</span>if (_.isFunction(options) &amp;&amp; <span class="branch-1 cbranch-no" title="branch not covered" >!callback)</span> {
...
<span class="cstat-no" title="statement not covered" >			options = {};</span>
		...
		var next = callback,
			cache = this.cache;
		<span class="missing-if-branch" title="if path not taken" >I</span>if (cache &amp;&amp; (<span class="branch-1 cbranch-no" title="branch not covered" >!options </span>|| <span class="branch-2 cbranch-no" title="branch not covered" >Object.keys(options).length === 0)</span>) {
<span class="cstat-no" title="statement not covered" >			var cached = cache.get('count');</span>
...
<span class="cstat-no" title="statement not covered" >			next = <span class="fstat-no" title="function not covered" >function (err, results) {</span></span>
<span class="cstat-no" title="statement not covered" >				if (results) {</span>
<span class="cstat-no" title="statement not covered" >					cache.set('count', results);</span>
				}
...
Model.prototype.upsertAPI = function upsertAPI() {
	...
	result.action = <span class="fstat-no" title="function not covered" >function upsertAction(req, resp, next) {</span>
<span class="cstat-no" title="statement not covered" >		try {</span>
<span class="cstat-no" title="statement not covered" >			req.model.upsert(req.params.id, req.params, next);</span>
		}
		catch (E) {
<span class="cstat-no" title="statement not covered" >			return next(E);</span>
		}
...
Model.prototype.upsert = function upsert(id, doc, callback) {
	...
	try {
		...
		var payload = instance.toPayload();
		var pk = this.getConnector().getPrimaryKey(this, instance) || 'id';
		<span class="missing-if-branch" title="if path not taken" >I</span>if (doc[pk]) {
<span class="cstat-no" title="statement not covered" >			payload[pk] = doc[pk];</span>
		}
		var next = callback,
			cache = this.cache;
		<span class="missing-if-branch" title="if path not taken" >I</span>if (cache) {
...
<span class="cstat-no" title="statement not covered" >					cache.del(id);</span>
				}
<span class="cstat-no" title="statement not covered" >				return callback &amp;&amp; callback.apply(this, arguments);</span>
			};
		}
...
Model.prototype.queryAPI = function queryAPI() {
	return {
		...
		action: <span class="fstat-no" title="function not covered" >function queryAction(req, resp, next) {</span>
<span class="cstat-no" title="statement not covered" >			try {</span>
<span class="cstat-no" title="statement not covered" >				resp.stream(req.model.query, req.params, next);</span>
			}
			catch (E) {
<span class="cstat-no" title="statement not covered" >				return next(E);</span>
			}
...
&nbsp;
	try {
		...
		this.getConnector().query(this, options, ((options &amp;&amp; options.limit &amp;&amp; options.limit === 1) ? function (err, collection) {
			...
			<span class="missing-if-branch" title="else path not taken" >E</span>if (collection) {
				var instance = collection &amp;&amp; collection[0];
				return callback(null, instance);
			}
<span class="cstat-no" title="statement not covered" >			return callback(null, collection);</span>
		} : callback));
	}
	catch (E) {
		return callback(E);
...
<span class="branch-0 cbranch-no" title="branch not covered" >			case 1:</span>
			{
<span class="cstat-no" title="statement not covered" >				return this.findAll(arguments[0]);</span>
			}
			case 2:
			{
				var options = arguments[0],
					callback = arguments[1];
				<span class="missing-if-branch" title="else path not taken" >E</span>if (_.isObject(options)) {
					return this.query(options, callback);
				}
<span class="cstat-no" title="statement not covered" >				return this.findByID(options, callback);</span>
			}
<span class="branch-2 cbranch-no" title="branch not covered" >			default:</span>
			{
<span class="cstat-no" title="statement not covered" >				throw new Error("wrong number of parameters passed");</span>
			}
		}
	};
&nbsp;
...
Model.prototype.getMeta = function getMeta(key, def) {
	var m1 = this._connector &amp;&amp; <span class="branch-1 cbranch-no" title="branch not covered" >this.metadata[this._connector];</span>
	<span class="missing-if-branch" title="if path not taken" >I</span>if (m1 &amp;&amp; <span class="branch-1 cbranch-no" title="branch not covered" >m1[key])</span> {
<span class="cstat-no" title="statement not covered" >		return m1[key];</span>
	}
	...
	<span class="missing-if-branch" title="if path not taken" >I</span>if (m3 &amp;&amp; m3[key]) {
<span class="cstat-no" title="statement not covered" >		return m3[key];</span>
	}
	return def || null;
};
&nbsp;
...
<span class="cstat-no" title="statement not covered" >		entry = this.metadata[connector.name] = {};</span>
	}
	entry[key] = value;
};
&nbsp;
...
function parseBoolean(obj) {
	<span class="missing-if-branch" title="if path not taken" >I</span>if (typeof(obj) === 'boolean') {
...
<span class="cstat-no" title="statement not covered" >		return obj;</span>
	...
	else <span class="missing-if-branch" title="if path not taken" >I</span>if (typeof(obj) === 'string') {
<span class="cstat-no" title="statement not covered" >		return new Date(Date.parse(obj));</span>
	}
	return obj;
}
&nbsp;
function parseNumber(obj) {
	<span class="missing-if-branch" title="if path not taken" >I</span>if (obj instanceof Number) {
<span class="cstat-no" title="statement not covered" >		return obj;</span>
	}
	else if (typeof(obj) === 'string') {
...
Model.prototype.translateKeysForPayload = function translateKeysForPayload(obj) {
	<span class="missing-if-branch" title="if path not taken" >I</span>if (obj &amp;&amp; _.isString(obj)) {
<span class="cstat-no" title="statement not covered" >		try {</span>
<span class="cstat-no" title="statement not covered" >			obj = JSON.parse(obj);</span>
	...
	for (var fieldKey in this.fields) {
		<span class="missing-if-branch" title="else path not taken" >E</span>if (this.fields.hasOwnProperty(fieldKey)) {
...
Model.prototype.get = function get(name, value, instance) {
	...
	<span class="missing-if-branch" title="else path not taken" >E</span>if (mapper) {
...
Model.prototype.getPrimaryKeyName = function getPrimaryKeyName() {
	...
	var exposePrimaryKeyAsId = Instance.Arrow &amp;&amp; <span class="branch-1 cbranch-no" title="branch not covered" >Instance.Arrow.getGlobal().config.serialization </span>? <span class="branch-0 cbranch-no" title="branch not covered" >Instance.Arrow.getGlobal().config.serialization.exposePrimaryKeyAsId </span>: false;
&nbsp;
	// returns the model's primary key column name or the default name 'id'
	return this.metadata &amp;&amp; this.metadata.primarykey &amp;&amp; <span class="branch-2 cbranch-no" title="branch not covered" >!exposePrimaryKeyAsId </span>? <span class="branch-0 cbranch-no" title="branch not covered" >this.metadata.primarykey </span>: 'id';
};
&nbsp;
/*
 Utility.
...
function parseProperties(object) {
	for (var key in object) {
		<span class="missing-if-branch" title="else path not taken" >E</span>if (object.hasOwnProperty(key)) {
			var val = object[key];
			<span class="missing-if-branch" title="if path not taken" >I</span>if (val &amp;&amp; typeof val === 'string' &amp;&amp; val[0] === '{') {
<span class="cstat-no" title="statement not covered" >				try {</span>
...
<span class="cstat-no" title="statement not covered" >					if (key === 'where') {</span>
<span class="cstat-no" title="statement not covered" >						err.message = 'Failed to parse "where" as JSON: ' + err.message;</span>
...
function mergeFields(definedFields, inheritedFields) {
	...
	for (var key in definedFields) {
		<span class="missing-if-branch" title="else path not taken" >E</span>if (definedFields.hasOwnProperty(key)) {
...
function translateQueryRegex(where) {
	for (var key in where) {
		<span class="missing-if-branch" title="else path not taken" >E</span>if (where.hasOwnProperty(key)) {
			var val = where[key];
			...
			else <span class="missing-if-branch" title="if path not taken" >I</span>if (_.isArray(val)) {
<span class="cstat-no" title="statement not covered" >				for (var i = 0; i &lt; val.length; i++) {</span>
<span class="cstat-no" title="statement not covered" >					if (_.isObject(val[i])) {</span>
<span class="cstat-no" title="statement not covered" >						translateQueryRegex(val[i]);</span>
					}
				}
			}
...
&nbsp;
	...
	for (var casedKey in options) {
		<span class="missing-if-branch" title="else path not taken" >E</span>if (options.hasOwnProperty(casedKey)) {
...
&nbsp;
	<span class="missing-if-branch" title="if path not taken" >I</span>if (ctx.defaultQueryOptions) {
<span class="cstat-no" title="statement not covered" >		options = _.merge(ctx.defaultQueryOptions, options);</span>
	}
&nbsp;
...
<div class='footer quiet pad2 space-top1 center small'>
  Code coverage
  generated by <a href="http://istanbul-js.org/" target="_blank">istanbul</a> at Wed Mar 29 2017 01:13:35 GMT-0700 (PDT)
</div>
</div>
