...
<html lang="en">
<head>
    <title>Code coverage report for arrow-orm/lib/collection.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">all files</a> / <a href="index.html">arrow-orm/lib/</a> collection.js
    </h1>
    <div class='clearfix'>
...
var getPrototypeOf = Object.getPrototypeOf || <span class="fstat-skip" title="function not covered" ><span class="branch-1 cbranch-skip" title="branch not covered" >function (o) {</span></span>
<span class="cstat-skip" title="statement not covered" >		return o.__proto__;</span>
	};
/* istanbul ignore next */
var setPrototypeOf = Object.setPrototypeOf || <span class="fstat-skip" title="function not covered" ><span class="branch-1 cbranch-skip" title="branch not covered" >function (o, p) {</span></span>
<span class="cstat-skip" title="statement not covered" >		o.__proto__ = p;</span>
<span class="cstat-skip" title="statement not covered" >		return o;</span>
	};
&nbsp;
function Collection(model, instances) {
	...
	var proto = isNew ? getPrototypeOf(this) : <span class="branch-1 cbranch-no" title="branch not covered" >Collection.prototype;</span>
...
function objectCustomizer(obj) {
	...
	else <span class="missing-if-branch" title="else path not taken" >E</span>if (Array.isArray(obj)) {
		var array = [];
	...
	else <span class="cstat-no" title="statement not covered" >if (obj.toJSON) {</span>
<span class="cstat-no" title="statement not covered" >		return obj.toJSON();</span>
	}
	else <span class="cstat-no" title="statement not covered" >if (_.isFunction(obj)) {</span>
<span class="cstat-no" title="statement not covered" >		return undefined;</span>
	}
	else <span class="cstat-no" title="statement not covered" >if (_.isObject(obj)) {</span>
<span class="cstat-no" title="statement not covered" >		return _.cloneDeep(obj, objectCustomizer);</span>
	}
