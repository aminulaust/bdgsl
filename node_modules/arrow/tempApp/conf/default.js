...
module.exports = {
	...
	admin: {
		...
		validEmails: ["admin@dashboard.local"],
		// set the organization ids you want to be able to log in to the admin website
		validOrgs: [980076903666876]
	},

	// you can generally leave this as-is since it is generated for each new project you created.
	session: {
		encryptionAlgorithm: 'aes256',
		encryptionKey: '0eBjsTmhpqpwWqh0+qYZzjK+evqgTHlSKxsDlp/N6uw=',
		signatureAlgorithm: 'sha512-drop256',
		signatureKey: 'WwfqK3pAa9r4ecUAp+bUqT3ecy6PzVcWJoaSzRVgtBBc5KE2gSQFD61dnqMhvwsltWtx+r1GCpT3XeATBpa1xQ==',
		secret: 'J1EQi1mXl2oKg0Zm4w5nwrqeo/rONkdP', // should be a large unguessable string
	...
	cookieSecret: 'P/OrR9IZyWkaiK8kpGDQRwO4XOpXNryE',
